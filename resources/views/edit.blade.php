    ...
    <div class="row justify-content-center">
        ...
        <form method="POST" action="/listings/{{$listing->id}}">
                ...
                <div class="form-group">
                    ...
                    <input type="integer" class="form-control" name="phone" id="phone" placeholder="Enter phone" value="{{$listing->phone}}">
                </div>
                <div class="form-group">
                    <label for="bio">Enter your bio</label>
                    <input type="email" class="form-control" name="bio" id="bio" placeholder="Enter bio" value="{{$listing->bio}}">
                </div>
